...
const YearsMovies = () => {
    ...
    useEffect(() => {
        const yearMovieURL = `${yearUrl}?api_key=${apiKey}&language=pt-BR&sort_by=popularity.desc&primary_release_year=${yearsmovies}&page=${page}
`;
        getYearmovies(yearMovieURL);
    }, [page, yearsmovies]);

    return <div className="yearContainer">
    <h1>
        Resultados para: <span className="query">{yearsmovies}</span>
    </h1>
